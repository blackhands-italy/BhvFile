...
namespace BHVEditor
{
    public class BHVFile
    {
        ...
        private void Parse(BinaryReader br)
        {
            ...
            if (Header.StateCount > 0)
            {
                ...
                for (int i = 0; i < Header.StateCount; i++)
                {
                    ...
                    st.Unk18_A = br.ReadInt16();
                    st.Unk18_B = br.ReadInt16();
                    st.Unk1C = br.ReadInt32();
                    st.Unk20 = br.ReadInt32();
                    st.Unk24 = br.ReadSingle();
                    st.Unk28 = br.ReadSingle();
                    st.Unk2C = br.ReadSingle();
                    st.Unk30 = br.ReadInt32();
                    st.Unk34 = br.ReadInt32();
                    st.Unk38 = br.ReadInt32();
                    st.Unk3C = br.ReadInt32();
                    st.Unk40 = br.ReadSingle();
                    st.Unk44_A = br.ReadInt16();
                    st.Unk44_B = br.ReadByte();
                    st.Unk44_C = br.ReadByte();
                    st.Unk48 = br.ReadInt32();
                    st.RootmotionStatus = br.ReadSingle();
                    st.Unk50 = br.ReadInt32();
                    st.BodyPartControlA = br.ReadByte();
                    st.BodyPartControlB = br.ReadByte();
                    st.BodyPartControlC = br.ReadByte();
                    st.BodyPartControlD = br.ReadByte();
                    ...
                    st.UnkBsControlId_A = br.ReadByte();
                    st.UnkBsControlId_B = br.ReadByte();
                    st.WeaponAnimationCallingId = br.ReadInt32();
                    st.Unk6C = br.ReadInt32();
                    st.BladeHomingControl_A = br.ReadInt16();
                    st.BladeHomingControl_B = br.ReadByte();
                    st.BladeHomingControl_C = br.ReadByte();
                    st.Unk74 = br.ReadSingle();
        ...
        private void Write(BinaryWriter bw)
        {
            ...
            foreach (var st in States)
            {
                ...
                bw.Write(st.Unk50);
                bw.Write(st.BodyPartControlA);
                bw.Write(st.BodyPartControlB);
                bw.Write(st.BodyPartControlC);
                bw.Write(st.BodyPartControlD);
                bw.Write(st.Unk58);
                bw.Write(st.Unk5C);
                bw.Write(st.LeftHandAnimationId << 16);
                bw.Write(st.StructBsid2);
                bw.Write(st.UnkBsControlId_A);
                bw.Write(st.UnkBsControlId_B);
                bw.Write(st.WeaponAnimationCallingId);
                bw.Write(st.Unk6C);
                bw.Write(st.BladeHomingControl_A);
                bw.Write(st.BladeHomingControl_B);
                bw.Write(st.BladeHomingControl_C);
                bw.Write(st.Unk74);
                bw.Write(st.Unk78);
                bw.Write(st.Unk7C);
                if (Header.Version >= 10)
    ...
    public class State
    {
        ...
        public short Unk18_A { get; set; }
        public short Unk18_B { get; set; }
        ...
        public short Unk44_A { get; set; }
        public byte Unk44_B { get; set; }
        public byte Unk44_C { get; set; }
        public int Unk48 { get; set; }
        public float RootmotionStatus { get; set; }
        public int Unk50 { get; set; }
        public byte BodyPartControlA { get; set; }
        public byte BodyPartControlB { get; set; }
        public byte BodyPartControlC { get; set; }
        public byte BodyPartControlD { get; set; }
        public int Unk58 { get; set; }
        public int Unk5C { get; set; }
        public int LeftHandAnimationId { get; set; }
        public short StructBsid2 { get; set; }
        public byte UnkBsControlId_A { get; set; }
        public byte UnkBsControlId_B { get; set; }
        public int WeaponAnimationCallingId { get; set; }
        public int Unk6C { get; set; }
        public short BladeHomingControl_A { get; set; } // 2 bytes
        public byte BladeHomingControl_B { get; set; }  // 1 byte
        public byte BladeHomingControl_C { get; set; }  // 1 byte
